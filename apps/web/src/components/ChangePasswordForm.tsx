  ...
  return (
    <form action={action} className="flex flex-col gap-4">
      <div>
        ...
        <input id="current" name="current" type="password" className="input w-full" required />
      </div>
      <div>
        <label className="block text-sm mb-1" htmlFor="next">
          新密码
        </label>
        <input id="next" name="next" type="password" className="input w-full" required />
      </div>
      <div>
        <label className="block text-sm mb-1" htmlFor="confirm">
          确认新密码
        </label>
        <input id="confirm" name="confirm" type="password" className="input w-full" required />
      </div>
